...
const strategyDescriptions = {
    'ma_cross': { name: '均線黃金交叉', desc: '短期SMA向上穿越長期SMA。\n參數: 短期SMA, 長期SMA', defaultParams: { shortPeriod: 5, longPeriod: 20 }, optimizeTargets: [{ name: 'shortPeriod', label: '短期SMA', range: { from: 3, to: 50, step: 1 } }, { name: 'longPeriod', label: '長期SMA', range: { from: 10, to: 500, step: 5 } }] },
