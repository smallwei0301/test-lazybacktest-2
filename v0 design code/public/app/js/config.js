...
const strategyDescriptions = {
    'ma_cross': { name: '均線黃金交叉', desc: '短期SMA向上穿越長期SMA。\n參數: 短期SMA, 長期SMA', defaultParams: { shortPeriod: 5, longPeriod: 20 }, optimizeTargets: [{ name: 'shortPeriod', label: '短期SMA', range: { from: 3, to: 50, step: 1 } }, { name: 'longPeriod', label: '長期SMA', range: { from: 10, to: 250, step: 2 } }] },
    'ma_above': { name: '價格突破均線', desc: '收盤價從下方突破SMA。\n參數: SMA週期', defaultParams: { period: 20 }, optimizeTargets: [{ name: 'period', label: 'SMA週期', range: { from: 5, to: 250, step: 2 } }] },
    ...
    'price_breakout': { name: '價格突破前高', desc: '價格突破前 N 日最高。\n參數: 觀察週期', defaultParams: { period: 20 }, optimizeTargets: [{ name: 'period', label: '觀察週期', range: { from: 5, to: 250, step: 2 } }] },
