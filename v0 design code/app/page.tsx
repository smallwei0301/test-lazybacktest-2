...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Footer */}
      <footer className="bg-slate-100 text-slate-700 py-12 mt-24">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-5 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <span className="text-lg font-bold text-slate-900">LazyBacktest</span>
                  <div className="text-xs text-slate-500">懶人股票回測</div>
                </div>
              </div>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-slate-700">Donate (斗內/贊助)</h4>
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="https://payment.opay.tw/Broadcaster/Donate/C0EB7741A027F28BA11ED9BDBEAD263A" target="_blank" rel="noopener" className="text-slate-500 hover:text-slate-800 transition-colors">
                    歐付寶
                  </a>
                </li>
                <li>
                  <a href="https://p.ecpay.com.tw/8AB5D6F" target="_blank" rel="noopener" className="text-slate-500 hover:text-slate-800 transition-colors">
                    綠界
                  </a>
                </li>
                <li>
                  <a href="https://www.paypal.com/ncp/payment/79RNTHL69MAPE" target="_blank" rel="noopener" className="text-slate-500 hover:text-slate-800 transition-colors">
                    PayPal
                  </a>
                </li>
              </ul>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-slate-700">支援與幫助</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="/app/guide.html" className="text-slate-500 hover:text-slate-800 transition-colors">使用教學</a></li>
                <li><a href="/app/faq.html" className="text-slate-500 hover:text-slate-800 transition-colors">常見問題</a></li>
                <li><a href="/app/contact.html" className="text-slate-500 hover:text-slate-800 transition-colors">寄信給我</a></li>
                <li><a href="/app/community.html" className="text-slate-500 hover:text-slate-800 transition-colors">社群討論</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-slate-700">其他說明</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="/app/privacy.html" className="text-slate-500 hover:text-slate-800 transition-colors">隱私政策</a></li>
                <li><a href="/app/disclaimer.html" className="text-slate-500 hover:text-slate-800 transition-colors">免責聲明</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-slate-700">更多功能</h4>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/stock-records" className="text-slate-500 hover:text-slate-800 transition-colors">
                    股票紀錄
                  </Link>
                </li>
                <li>
                  <a href="/app/index.html" className="text-slate-500 hover:text-slate-800 transition-colors">
                    股票回測
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-slate-300/60 mt-8 pt-8 text-center text-sm text-slate-500">
            <p>
              鄉民內部測試版: 建議事項與 Bug，請聯絡信箱: <a href="mailto:smallwei0301@gmail.com" className="underline hover:text-slate-800 transition-colors">smallwei0301@gmail.com</a>
            </p>
            <p className="text-xs text-slate-400 mt-2">© 2025 LazyBacktest. 僅供教育與研究用途，不構成投資建議。</p>
          </div>
        </div>
      </footer>
    </div>
