...
const steps = [
  {
    ...
    tip: "如果不知道該股票代號，點選一鍵回測欄位中的「台積電」文字即可輸入股票名稱。",
    links: [
  ...
  },
  {
    ...
    description:
      "在左側的「基本設定」卡片中，您可以自訂回測的起訖日期與初始本金。請自行輸入想要回測的「最近幾年」（例如 3 ，預測為5），並按下「套用」才會生效。請注意，若您輸入的日期早於該股票上市日，系統會自動從最早可取得的資料日開始計算；更改任何設定後，都必須再次點擊「執行回測」才會更新結果。",
  ...
  },
  {
    ...
    links: [
      { href: "/stock-records", label: "把交易結果同步到股票紀錄(功能未完成，建置中)" },
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    tip: "若有觸及停損或停利，交易紀錄中會個別顯示是停損或停利。",
    links: [],
  },
  {
    id: 7,
    ...
    links: [
      { href: "/community", label: "把策略分享至社群討論(功能建置中)" },
    ],
  },
  {
    id: 8,
    ...
    tip: "批量優化需要較長運算時間，建議使用電腦操作，先鎖定兩到三個核心條件再啟動，並隨時留意上方進度條。",
    links: [
