...
const entryGlossary = [
  ...
  },
  {
    label: "布林通道突破",
    description:
      "布林通道用的是價格的移動平均值加減標準差，讓你可以看到市場普通波動範圍。突破上下軌並不是單純漲跌，而是當價格離開這個區間時代表近期波動變大，特別是突破上軌就意味著短期價格高於過去平均加上偏移值，換句話說，市場的平均震幅變大，代表多方以高於常態的強度推高價格，可用來理解力量是否正擴散。此策略通常在盤整區間突破時效果最佳，是捕捉趨勢啟動的經典訊號。",
  },
  {
    label: "KD 黃金交叉 (D<X)",
    description:
...
const exitGlossary = [
  ...
  },
  {
    label: "布林通道反轉",
    description:
      "布林通道的中軌是移動平均，兩側是標準差乘上後形成範圍。當價格從上軌回到中軌或下軌時，指標在說這段時間的波動回歸正常，表示原本距離平均值太遠的行情正在收斂。它的核心不是漲跌，而是說明價格失去比過去更大的偏移幅度，幫助你理解超出常態的價格是否回歸。此策略適合用於捕捉趨勢末端的反轉訊號，在價格過度延伸後鎖定利潤並避開回檔風險。",
  },
  {
    label: "KD 死亡交叉 (D>Y)",
    description:
