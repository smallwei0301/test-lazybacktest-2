    ...
    for (let iter = 0; iter < maxInternalIterations; iter++) {
        ...
        for (let i = 0; i < optimizeTargets.length; i++) {
            ...
            if (baseParamsOverride) {
                ['stockNo', 'startDate', 'endDate', 'market', 'marketType', 'adjustedPrice', 'splitAdjustment', 'tradeTiming', 'initialCapital', 'positionSize', 'positionBasis', 'buyFee', 'sellFee', 'enableShorting', 'entryStages', 'exitStages'].forEach((key) => {
