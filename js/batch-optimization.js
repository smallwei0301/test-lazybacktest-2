...
// Patch Tag: LB-BATCH-CACHE-20251018B
...
function resolveWorkerCachePayload(params, options = {}) {
    ...
    if (overrideData) {
        ...
        result.bypassWorkerDataset = false;
        return result;
    }
    ...
    return new Promise((resolve) => {
        try {
            ...
            if (workerUrl) {
                ...
                if (cachePayload.bypassWorkerDataset) {
                    workerMessage.forceFreshData = true;
                }
