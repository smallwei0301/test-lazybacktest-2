...
const strategyDescriptions = {
    ...
    'volume_spike_exit': { name: '成交量暴增出場', desc: '出場：成交量 > N日均量 * 倍數。\n參數: 倍數, 平均週期', defaultParams: { multiplier: 2, period: 20 }, optimizeTargets: [{ name: 'period', label: '平均週期', range: { from: 5, to: 60, step: 2 } }, { name: 'multiplier', label: '倍數', range: { from: 1.2, to: 6, step: 0.2 } }] },
    ...
    'short_volume_spike': { name: '成交量暴增 (做空)', desc: '做空：成交量 > N日均量 * 倍數。\n參數: 倍數, 平均週期', defaultParams: { multiplier: 2, period: 20 }, optimizeTargets: [{ name: 'period', label: '平均週期', range: { from: 5, to: 60, step: 2 } }, { name: 'multiplier', label: '倍數', range: { from: 1.2, to: 6, step: 0.2 } }] },
    ...
    'cover_volume_spike': { name: '成交量暴增 (回補)', desc: '回補：成交量 > N日均量 * 倍數。\n參數: 倍數, 平均週期', defaultParams: { multiplier: 2, period: 20 }, optimizeTargets: [{ name: 'period', label: '平均週期', range: { from: 5, to: 60, step: 2 } }, { name: 'multiplier', label: '倍數', range: { from: 1.2, to: 6, step: 0.2 } }] },
...
const longEntryToCoverMap = {
    ...
    'williams_oversold': 'cover_williams_oversold',
    'turtle_breakout': 'cover_turtle_breakout', 'volume_spike': 'cover_volume_spike'
};
...
const longExitToShortMap = {
    ...
    'volume_spike': 'short_volume_spike', 'volume_spike_exit': 'short_volume_spike'
};
