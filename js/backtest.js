...
function updateStrategyParams(type) {
    if (window.lazybacktestStrategyUiInstance && typeof window.lazybacktestStrategyUiInstance.updatePrimaryByType === 'function') {
        window.lazybacktestStrategyUiInstance.updatePrimaryByType(type);
        return;
    }
