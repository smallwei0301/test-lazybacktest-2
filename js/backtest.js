...
function displayBacktestResult(result) { 
    ...
    const sensitivityHtml = ((rawData) => {
        const data =
            rawData && Array.isArray(rawData.groups) && rawData.groups.length > 0
                ? rawData
                : null;
