...
(function() {
    ...
    function startRollingTest(event) {
        ...
        const baseParams = resolveRollingBaseParams();
        if (!baseParams) {
    ...
    function resolveRollingBaseParams() {
        const executed = typeof window !== 'undefined' ? window.lazybacktestLastExecutedParams : null;
        if (executed && typeof executed === 'object') {
            return deepClone(executed);
        }
        if (typeof getBacktestParams === 'function') {
            const params = getBacktestParams();
            return params ? deepClone(params) : null;
        }
        return null;
    }
    ...
    function getRollingConfig() {
        ...
        const params = resolveRollingBaseParams();
