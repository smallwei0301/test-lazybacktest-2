...
(function (root) {
  ...
  const loaders = {
    ...
    priceVolume: createScriptLoader('strategy-plugins/price-volume.js'),
  ...
  const definitions = [
    ...
    { id: 'cover_ema_cross', label: 'EMA交叉 (回補)', paramsSchema: maSchema, loader: loaders.ma },
    {
      ...
      paramsSchema: {
        type: 'object',
        properties: { period: { type: 'integer', minimum: 1, maximum: 365, default: 20 } },
        additionalProperties: true,
      },
      loader: loaders.maThreshold,
    },
    {
      id: 'ma_below',
      label: '價格跌破均線',
    ...
    },
    {
      ...
      paramsSchema: {
        type: 'object',
        properties: {
          shortPeriod: { type: 'integer', minimum: 1, maximum: 200, default: 12 },
          longPeriod: { type: 'integer', minimum: 1, maximum: 400, default: 26 },
          signalPeriod: { type: 'integer', minimum: 1, maximum: 200, default: 9 },
        },
        additionalProperties: true,
      },
      loader: loaders.macd,
    ...
    },
    {
      ...
      paramsSchema: {
        type: 'object',
        properties: { breakoutPeriod: { type: 'integer', minimum: 1, maximum: 365, default: 20 } },
        additionalProperties: true,
      },
      loader: loaders.turtle,
    },
    {
      id: 'turtle_stop_loss',
      label: '海龜停損 (N日低)',
      paramsSchema: {
        type: 'object',
        properties: { stopLossPeriod: { type: 'integer', minimum: 1, maximum: 365, default: 10 } },
        additionalProperties: true,
      },
      loader: loaders.turtle,
    },
